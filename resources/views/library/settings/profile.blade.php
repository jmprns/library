...
<div class="row">
	<div class="col-lg-7">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<form method="POST" action="/library/settings/profile/information">
...
<div class="row">
    <div class="col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="/library/settings/profile/username">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" class="form-control" id="profile-username" name="username" value="{{ Auth::user()->username }}" required>
                            
                        </div>
                        <div class="form-group col-md-4">
                            <label for="book-category"><strong>.</strong></label>
                ...
                <form method="POST" action="/library/settings/profile/password">
                    @csrf
                    <div class="form-group">
